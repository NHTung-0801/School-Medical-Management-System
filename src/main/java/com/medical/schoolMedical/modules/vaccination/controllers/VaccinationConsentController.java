...
public class VaccinationConsentController {
    ...
    // Lấy danh sách các học sinh được phụ huynh đồng ý cho khám/tiêm nhưng chưa tiêm
    ...
    // Lấy danh sách các học sinh được phụ huynh đồng ý cho tiêm chủng và đã được tiêm
